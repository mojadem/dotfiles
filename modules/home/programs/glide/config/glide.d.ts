...
declare global {
  ...
  namespace glide {
    ...
    export type AddonType =
      "extension" | "theme" | "locale" | "dictionary" | "sitepermission";
...
declare global {
  ...
  namespace Browser {
    ...
    namespace ActivityLog {
       ...
       */
      type OnExtensionActivityDetailsTypeTypeEnum =
        "api_call" | "api_event" | "content_script" | "user_script";
      /**
       * The type of view where the activity occurred.  Content scripts will not have a viewType.
       */
    ...
    namespace Experiments {
      ...
      type APIParentScope =
        "addon_parent" | "content_parent" | "devtools_parent";
    ...
    namespace ExtensionTypes {
      ...
      type ExtensionFileOrCode =
        ExtensionFileOrCodeC1Type | ExtensionFileOrCodeC2Type;
      /**
       * A plain JSON value
       */
    ...
    namespace Management {
      ...
      type ExtensionInstallType =
        "development" | "normal" | "sideload" | "admin" | "other";
      /**
    ...
    namespace Manifest {
      ...
      interface WebExtensionManifest extends ManifestBase {
        ...
        content_security_policy?:
          string | WebExtensionManifestContentSecurityPolicyC2Type;
        /**
         * Optional.
         */
        ...
        web_accessible_resources?:
          string[] | WebExtensionManifestWebAccessibleResourcesC2ItemType[];
        /**
         * Optional.
         */
        hidden?: boolean;
      ...
      type OptionalPermissionOrOrigin =
        OptionalPermission | OptionalOnlyPermission | MatchPattern;
      ...
      type OptionalDataCollectionPermission =
        CommonDataCollectionPermission | "technicalAndInteraction";
      ...
      type MatchPattern =
        "<all_urls>" | MatchPatternRestricted | MatchPatternUnestricted;
      /**
    ...
    namespace NetworkStatus {
       ...
       */
      type NetworkLinkInfoTypeEnum =
        "unknown" | "ethernet" | "usb" | "wifi" | "wimax" | "mobile";
      interface Static {
        /**
    ...
    namespace WebRequest {
      ...
      type SecurityInfoProtocolVersionEnum =
        "TLSv1" | "TLSv1.1" | "TLSv1.2" | "TLSv1.3" | "unknown";
      /**
       * The type of certificate error that was overridden for this connection, if any.
       */
      type SecurityInfoOverridableErrorCategoryEnum =
        "trust_error" | "domain_mismatch" | "expired_or_not_yet_valid";
      /**
       * Contains the HTTP request body data. Only provided if extraInfoSpec contains 'requestBody'.
       */
