...
map global user p '<a-!>paste<ret>' -docstring 'paste system clipboard after selection'
map global user P '!paste<ret>' -docstring 'paste system clipbard before selection'
