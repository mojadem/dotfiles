...
set -x FZF_DEFAULT_OPTS "--layout=reverse --style=minimal --color=bg:black,fg:white,hl:green,bg+:#$GRUVBOX_BG_S,fg+:bright-white,hl+:green,prompt:cyan,input-fg:bright-white,pointer:white,marker:white"
